let boardgames = [
...

	{
		...
		description: [
			...
			`Become part of the movement and discover how to resist corporate and government priorities that perpetuate policies resulting in hunger amidst abundance.`,
			`Together with your fellow players, you will develop strategies to tackle the problem of hunger and injustice.`
		],
		align: 'end',
	...
	},
	{
		...
		description: [
			...
			// `Squats can have different ideological orientations, whether anarchist, autonomist, or socialist. What kind of squat will you build?`
		],
		align: 'start',
