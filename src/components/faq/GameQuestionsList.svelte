...
export let data = {}
 ...
 <Card style="width: 100%; max-width: 100%; min-width: 300px;background-color: {data.promo.brandColor};">
        ...
        <Media style="background-image: url({data.promo.banner}); max-height: 300px; height: 230px; width: 100%; min-width: 300px; "/>
            <Content class="mdc-typography--body2">
                 <div style="display: flex; justify-content: center;">
                    <Card style='width: 300px;  border-color: {data.promo.brandColor};  height: 80px; margin-bottom: 15px;'>
