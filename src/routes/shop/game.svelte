...
<ColorFaq  title="Promo, video review and gameplay"  >
  <div style="display: flex; justify-content: center; align-content: center;  flex-direction: column;"  ></div>
  <div style="display: flex; flex-direction: row; margin-bottom: 15px;">
  {#each game.videos as video}
    <Card style="min-width: 200px; margin: 5px;">
   <PrimaryAction on:click={() => location.href = video.link}>
    ...
    {/each}
         ...
         <Card style='width: 530px; background-color: #47babb;  height: 80px; '>
...
<BlackFaq title=".... is a game of woodland might and right."> 
...
<!-- <Paper color="primary" style="width: auto; max-width: 760px; " class="paper-demo">
   ...
   <Card style="margin-bottom: 15px; width: auto; max-width: 760px;">
        ...
        flex-wrap: wrap;">
                ...
                >
                <Label style="font: 24px 'grafitty';">2-4 Players</Label>
                ...
                class="button-shaped-round"
                >
                <Label style="font: 24px 'grafitty';">8+ age</Label>
                ...
                class="button-shaped-round"
                >
                <Label style="font: 24px 'grafitty';">60–90 min.</Label>
    ...
    <Card  style="width: 460px; background-color: #47babb;">
      <Content>        <span style="font: 24px 'grafitty';">price: 60 euro</span>
</Content>
      <Actions style="background-color: #47babb;" fullBleed>
        <Button on:click={() => clicked++}>
...
{#each game.fullInfo.сharacters as сharacter}
         <Card style="width: 350px; height: 400px; margin: 15px;">
...
<!-- Root:  -->
 <div style="display: flex; justify-content: center;align-items: center;  flex-direction: row; flex-wrap: wrap; max-width: 760px;">
    ...
    <Card style="min-width: 300px; margin: 5px;">
...
<ColorFaq title="Resources">
<!-- ресурсы для скачивания -->
 <List style="max-width: 760px; width: 100%; margin-bottom: 25px;" class="demo-list">
{#each game.resources.concat(game.videos) as resource}
    <Item style="border: 2px solid #47babb;" on:SMUI:action={() => (clicked = 'Cut')}><Text style="color: #47babb;">{resource.name}{resource.type == 'pdf' ? `.${resource.type} 📄`: `  (${resource.type} 📺)`}</Text></Item>
    {/each}
  </List>


  <!-- <h5 style="font-family: 'grafitty'; color: #47babb;" class="mdc-typography--headline4">Updates</h5>
...
<BlackFaq title="Customers Who Bought This Item Also Bought">
